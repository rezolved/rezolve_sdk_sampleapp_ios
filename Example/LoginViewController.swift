...
class LoginViewController: UIViewController {
    ...
    private func createSession(entityId: String, partnerId: String) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            strongSelf.rezolveSdk.createSession(accessToken: accessToken, entityId: entityId, partnerId: partnerId, callback: { rezolveSession in
                ...
                print("Error -> \(String(describing: httpResponse.error?.first))")
            }
        }
    }
